...
#region LBInit && Singleton && DDOL
    ...
    public void WriteToLeaderboard(float score) => WriteToLeaderboard(new LeaderboardEntry(playerEntry) { Score = score });
    public void WriteToLeaderboard(string leaderboard,float score) => WriteToLeaderboard(leaderboard, new LeaderboardEntry(playerEntry) { Score = score });
    ...
    public void FindClosest(float score) => FindClosest(new LeaderboardEntry(playerEntry) { Score = score });
    public void FindClosest(string leaderboard,float score) => FindClosest(leaderboard, new LeaderboardEntry(playerEntry) { Score = score });
...
public class Leaderboard : object
{
    ...
    public IEnumerator Write(LeaderboardEntry entry)
    {
        ...
        ActiveWrite = null;
        Debug.Log("Write complete: " + (Time.timeSinceLevelLoad - starttime).ToString("n0"));
    }
    /// <summary>
